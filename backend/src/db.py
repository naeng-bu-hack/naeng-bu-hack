...
MOCK_RECIPE_DETAILS: dict[str, dict[str, Any]] = {
    'general': {
        'id': 'general',
        'title': '김치볶음밥',
        'servings': 2,
...
def fetch_recommendations(ingredients: list[str], cuisine: str, max_minutes: int) -> list[dict[str, Any]]:
    # TODO: 실제 DB 조회로 교체
    _ = (ingredients, cuisine, max_minutes)
    return MOCK_RECIPES


def fetch_recipe_detail(recipe_id: str) -> dict[str, Any] | None:
    # TODO: 실제 DB 조회로 교체
